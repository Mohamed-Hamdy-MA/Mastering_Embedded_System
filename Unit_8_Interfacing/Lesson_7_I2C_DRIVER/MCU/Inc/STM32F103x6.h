...
#define RCC_I2C1_CLK_RST()		RCC->RCC_APB1RSTR |= (1 << 21); RCC->RCC_APB1RSTR &= ~(1 << 21); //Bit 21 I2C1RST: I2C1 clock enable
#define RCC_I2C2_CLK_RST()		RCC->RCC_APB1RSTR |= (1 << 22); RCC->RCC_APB1RSTR &= ~(1 << 22); //Bit 22 I2C2RST: I2C2 clock enable
