 ...
 * @param  USART_Mechanism Specifies the mechanism to be used for transmission (Polling or Interrupt).
 *
 * @retval None
 *
 ...
 * @example
 * uint16_t data = 0x123;
 * MCAL_USART_SendData(USART1, &data, Polling);
 ...
 * @param  USART_Mechanism Specifies the mechanism to be used for reception (Polling or Interrupt).
 *
 * @retval None
 *
 * @note    - Ensure that the USART peripheral is initialized before calling this function.
 ...
 * @example
 * uint16_t data;
 * MCAL_USART_ReceiveData(USART1, &data, Polling);
