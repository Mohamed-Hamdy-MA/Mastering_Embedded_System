...
typedef struct
{
	uint16_t GPIO_PinNumber; //This parameter can be a value of @reference GPIO_PinNumber_Define
	uint8_t GPIO_PinMode; //This parameter can be a value of @reference GPIO_PinMode_Define
	uint8_t GPIO_PinSpeed; //This parameter can be a value of @reference GPIO_PinSpeed_Define
}GPIO_PinConfig_t;
 ...
 * pinConfig.PinNumber = GPIO_PinNumber_0;
 * pinConfig.PinMode = GPIO_PinMode_Output_PUSHPULL;
 * pinConfig.PinSpeed = GPIO_PinSpeed_10MHz;
 ...
 *
 * @retval uint8_t    The input state of the pin can be a value of @reference GPIO_PinValue_Define (0 or 1).
 *
 ...
 *
 * @retval uint8_t    The lock status can be a value of @reference GPIO_PinLock_Define (0 if unsuccessful, 1 if successful).
 *
